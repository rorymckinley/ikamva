...
describe MembersController do
  ...
  it "should allow a member to be edited" do
    post :create, :branch_id => @branch_1.id, :member => { :first_name => 'Test', :surname => 'Member', :card_number => '1235', :participation => 'volunteer'}
    @branch_1.reload
    put :update, :branch_id => @branch_1.id, :id => @branch_1.members.first.id, :member => { :first_name => 'Edited', :surname => 'Member', :card_number => '1236', :participation => 'learner' }
    @branch_1.members.first.reload
    @branch_1.members.first.first_name.should == 'Edited'
    @branch_1.members.first.surname.should == 'Member'
